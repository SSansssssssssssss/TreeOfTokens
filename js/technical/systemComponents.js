    ...
    'options-tab': {
        ...
        <table>
			...
			<tr>
				...
				<td><button class="opt" onclick="fixbgtest()">Fix Run in BG: {{ options.fixbg?"YES":"NO" }}</button></td>
				<td><button class="opt" onclick="toggleOpt('autoCollect')">Auto-Collect: {{ options.autoCollect?"ON":"OFF" }}</button></td>
            </tr>
        </table>`
    },
